...
class SongControllerTest extends TestCase {
    ...
    public function testList(){
      $this->create(10);
      // Pages
      $this->visit('/song/list')->see('code')->see('name')->see('lyrics')->see('Actions');
      // Json
      /*$this->get('/song/get/many?draw=0&start=0&length=2')->seeJson([
                '0'=>1//,'1' => 's1','2' => 'My song','3'=>'The lines of the lyrics'
             ]);*/

       $this->get('/song/get/many?draw=0&start=0&length=2')->seeJsonStructure([
                  'data' => [
                      '0'=>1//,'1' => 's0','2' => 'My song','3'=>'The lines of the lyrics'
                  ]
              ]);

        $this->get('/song/get/many?draw=0&start=0&length=2')->seeJsonStructure([
                   'data' => [
                       '1' => 's0'//,'2' => 'My song','3'=>'The lines of the lyrics'
                   ]
               ]);
    }
